...
public class UserJpaEntity implements UserDetails {
    ...
    public UserJpaEntity(Long id, String name, String email, String login, String password, LocalDateTime createdAt, LocalDateTime updatedAt, Set<RoleJpaEntity> roles) {
        this.id = id;
        this.name = name;
        this.email = email;
        this.login = login;
