...
public class StudentController {
    ...
    public StudentController(UserApplicationService userService, DeleteUserUseCase deleteUserUseCase) {
        this.userService = userService;
        this.deleteUserUseCase = deleteUserUseCase;
    }

    @PostMapping
    public ResponseEntity<UserResponseDTO> createStudent(@Valid @RequestBody CreateUserDTO dto) {
